...
let Card = (props) => {
    ...
    if (!!data.university) {
        Uinfo = (
            <div className="info text-md md:text-lg lg:text-xl mb-3 text-gray-400 flex flex-col md:justify-center">
    ...
    return (
        <motion.div
            ...
            className="transition-all cursor-pointer flex flex-col bg-gray-800 w-2/5 md:w-54 lg:w-72 xl:w-80 rounded-2xl m-2 max-h-96 md:m-4 p-0 shadow-xl text-gray-900"
        >
            <img
                src={imgUrl}
                alt=""
            ...
            <div className="grid grid-cols-1 content-center flex-1 flex-grow-1 mx-2 my-2 text-white">
