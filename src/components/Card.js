let Card = (props) => {
    ...
    return (
        <div
            ...
            className="transition-all cursor-pointer flex flex-col bg-white w-2/5 md:w-54 lg:w-72 rounded-2xl m-2 max-h-96 md:m-4 p-0 shadow-xl text-gray-900"
        >
            <img
                src={imgUrl}
                alt=""
            ...
            <div className="grid grid-cols-1 content-center flex-1 flex-grow-1 mx-2 my-2">
                <div className="name text-2xl md:text-2xl lg:text-3xl flex flex-col lg:flex-row items-center  mb-0 md:justify-center">
