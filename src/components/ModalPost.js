let ModalPost = (props) => {
    ...
    return (
        <div className="ModalPost z-50 fixed w-screen h-screen  bg-gray-900 bg-opacity-80 flex items-center justify-center">
            <div onClick={() => onBgClick(null)} className="w-screen h-screen fixed"></div>
            <div className="main-box z-20 bg-white rounded-3xl  lg:flex-row lg:h-4/5 lg:w-2/3 w-4/5 flex flex-col items-center">
                <img
                    src={imgUrl}
                ...
                <div className="grid content-center flex-1 flex-grow-1">
                    <div className="name flex flex-col items-center  my-3 lg:justify-center">
